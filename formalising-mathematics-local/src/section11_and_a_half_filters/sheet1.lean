...
begin
  ...
  { intro h,
    split,
    { exact mem_of_superset h (inter_subset_left S T), },
    { exact mem_of_superset h (inter_subset_right S T), }, },
  { intro h,
    exact inter_mem h.left h.right},
end
...
{ sets := {S : set α | X ⊆ S},
  ...
  sets_of_superset := begin
    intros x y hx hxy,
    have hX: X ⊆ x, { exact hx, },
    exact subset.trans hX hxy,
  end,
  inter_sets := begin
    intros x y hx hy,
